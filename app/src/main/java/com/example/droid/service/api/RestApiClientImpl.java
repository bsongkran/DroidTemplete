...
public class RestApiClientImpl implements RestApiClient {
    ...
    private RestApiEndPoints restApiEndPoints;
     ...
     */
    @Inject
    public RestApiClientImpl(Context context) {
    ...
    public void initializeApi() {
        ...
        // Service setup
        restApiEndPoints = retrofit.create(RestApiEndPoints.class);
    }

    @Override
    public RestApiEndPoints getRestApiEndPoints() {
