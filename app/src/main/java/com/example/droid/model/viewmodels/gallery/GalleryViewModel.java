 ...
 */
public class GalleryViewModel extends BaseObservable implements IViewModel {
    ...
    public GalleryViewModel(Context context, IDataChangedListener dataChangedListener , RestApiClient restApiClient) {
