...
import com.monaosoftware.droid.databinding.FragmentMapBinding;
...
import com.monaosoftware.droid.util.NetworkUtil;
...
public class MapFragment extends Fragment implements GoogleMap.OnInfoWindowClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (MarshMallowPermission.getInstant(getActivity()).checkPermissionForAccessFineLocation()) {
            fusedLocationService = FusedLocationService.getFusedLocationService(context, getActivity());
        }
    }
